...
export type FooterProps =
  HZTLSWAG.Templates.Sitecore.templates.swagstore.DataSourceTemplate.GlobalComponents.Fields.Footer;
          ...
          <div className="py-20 xl:grid xl:grid-cols-12 xl:gap-8">
            ...
            <div className="space-y-12 col-start-5 col-span-2 md:gap-8 md:space-y-0">
              ...
              <ul role="list" className="mt-6 space-y-6">
                {props?.fields?.list1Links.map((itm, index) => {
                  console.log(itm);
                  return (
            ...
            <div className="space-y-12 col-span-2 md:gap-8 md:space-y-0">
              ...
              <ul role="list" className="mt-6 space-y-6">
                {props?.fields?.list2Links.map((itm2, index) => {
                  console.log(itm2);
                  return (
                    <li className="text-sm text-white" key={index}>
            ...
            <div className="space-y-12 col-span-2 md:gap-8 md:space-y-0">
              <div>
                ...
                <ul role="list" className="mt-6 space-y-6">
                  {props?.fields?.socialMediaLinks.map((itm, index) => {
                    console.log(itm);
                    return (
                      <li className="text-sm text-white" key={index}>
                        <Link field={itm.fields.link} />
