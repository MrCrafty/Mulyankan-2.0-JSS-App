...
type CategoryListProps = HZTLSWAG.Templates.Sitecore.templates.swagstore.DataSourceTemplate.Fields.CategoryListing;

const ProductList = (props: CategoryListProps) => {
    return (
        <div><section aria-labelledby="category-heading" className="pt-12 pb-12 sm:pt-32 xl:mx-auto xl:max-w-7xl xl:px-8">
            <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
                <Text field={props?.fields?.title} tag='h2' id="category-heading" className="text-2xl font-bold tracking-tight text-gray-900" />
            </div>
                                ...
                                return (
                                    <a href={itm.url} className="relative flex h-80 w-56 flex-col overflow-hidden rounded-lg p-6 hover:opacity-75 xl:w-auto">
                                        <span aria-hidden="true" className="absolute inset-0">
                                            <Image src={itm?.fields.Thumbnail.value.src} alt="" width={200} height={200} className="h-full w-full object-cover object-center" />
                                        </span>
